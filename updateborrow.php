...
if (isset($_POST['saveBook'])) {
    ...
    $sql = "UPDATE `book` SET `isbn`='$isbn',`title`='$title',`author`='$author',`publication_date`='$publication_date',`status`='[value-6]' WHERE title='$title'";
...
<?php @include 'includes/header.php' ?>
    ...
    <div class="row border my-5 rounded-5 p-3 bg-white">
        <div class="col-md-12">
            <div class="card">
